                ...
                >
                  <span
                    className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                      showAllMode ? 'translate-x-6' : 'translate-x-1'
                    }`}
                  />
                </button>
              </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      ...
                      return (
                        <div
                          ...
                          className={`group p-4 rounded-xl border-2 cursor-pointer transition-all duration-200 transform hover:scale-105 relative ${
                            isSelected 
                          ...
                          {!showAllMode && (
                            <div className="absolute top-2 right-2 flex items-center gap-1">
                              {displayConfig.priority === 'high' && (
                                <div className="flex items-center gap-1 px-2 py-1 bg-gradient-to-r from-yellow-400 to-orange-500 text-white text-xs font-bold rounded-full shadow-sm">
                                  ⭐ <span>Top</span>
                                </div>
                              )}
                              ...
                              {userProfile && displayConfig.targetAudience === userProfile && (
                                <div className="px-2 py-1 bg-green-500 text-white text-xs font-medium rounded-full shadow-sm">
                                  👤 Para você
                                </div>
                              )}
                            </div>
